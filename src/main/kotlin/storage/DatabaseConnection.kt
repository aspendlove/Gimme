...
//import java.sql.*
//
//class DatabaseConnection(val connection: Connection, val invalidateCache: () -> Unit) {
...
//        }
//
//        if (!doesTableExist(TableNames.userTableName)) {
//            connection.prepareStatement(
//                """
...
//        }
//
//        if (!doesTableExist(TableNames.itemTableName)) {
//            connection.prepareStatement(
//                """
...
//        }
//
//        if (!doesTableExist(TableNames.invoiceTableName)) {
//            connection.prepareStatement(
//                """
...
//     */
//    private fun deleteRowById(tableName: String, id: Int): Boolean {
...
//        return deleteRowById(TableNames.invoiceTableName, id)
//    }
//
//    /**
...
//        return deleteRowById(TableNames.userTableName, id)
//    }
//
//    /**
...
//        return deleteRowById(TableNames.clientTableName, id)
//    }
//
//    /**
//     * Delete a single client by id
...
//        return deleteRowById(TableNames.itemTableName, id)
//    }
//
//    /**
